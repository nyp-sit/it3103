...
img = load_image_into_numpy_array("/home/markk/git/it3103/week5/balloon_project/test_samples/single.jpg")
print(img.shape)
...
names = ['output scores', "boxes", "num of detections", "classes" ]
